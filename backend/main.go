...
func main() {
	...
	// Account
	http.HandleFunc("/api/account/summary", bbookAPI.HandleGetAccountSummary)
	http.HandleFunc("/api/account/create", bbookAPI.HandleCreateAccount)

	// Positions (B-Book)
	http.HandleFunc("/api/positions", bbookAPI.HandleGetPositions)
	http.HandleFunc("/api/positions/close", bbookAPI.HandleClosePosition)
	http.HandleFunc("/api/positions/close-bulk", bbookAPI.HandleCloseBulk)

	// Orders (B-Book)
	http.HandleFunc("/api/orders", bbookAPI.HandleGetOrders)
	http.HandleFunc("/api/orders/market", bbookAPI.HandlePlaceMarketOrder)

	// Trades & Ledger
	http.HandleFunc("/api/trades", bbookAPI.HandleGetTrades)
	http.HandleFunc("/api/ledger", bbookAPI.HandleGetLedger)
